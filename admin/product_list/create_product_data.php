                ...
                <div class="container-fluid">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        if (mysqli_num_rows($check) == 0) {
                            $sql = mysqli_query($connection, "INSERT INTO product_list(code, name, price, category, stock) 
                            VALUES('$code', '$name', '$price', '$category', '$stock' )");
                    ...
                    <form action="create_product_data.php" method="POST">
                        <div class="form">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    <input type="text" name="price" class="form-control" size="4" required>
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    <input type="text" name="stock" class="form-control" size="4" required>
                                </div>
                            </div>
