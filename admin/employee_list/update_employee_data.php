            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    if (isset($_GET['uid'])) {
                        ...
                        $select = mysqli_query($connection, "SELECT * FROM employee_data WHERE uid = '$uid' ");
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $sql = mysqli_query($connection, "UPDATE employee_data SET name = '$name', email = '$email', position = '$position', phone = '$phone', gender = '$gender', namefile = '$fileName', typefile = '$fileSize', size = '$fileSize', picture = '$photouser' WHERE uid = '$uid' ");
                        if ($sql) {
                            echo '
                            <script>
                    ...
                    <form action="update_employee_data.php?&uid=<?php echo $uid; ?>" method="POST" enctype="multipart/form-data">
                        <div class="form">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    <input type="text" name="uid" class="form-control" size="4" value="<?php echo $data['uid']; ?>" readonly required>
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    <select type="text" name="position" class="form-control" required>
                                        ...
                                        <option value="General Manager" <?php if ($data['position'] == 'General Manager') {
                                                                            echo 'selected';
                                                                        } ?>>General Manager</option>
                                        <option value="IT Support" <?php if ($data['position'] == 'IT Support') {
                                                                        echo 'selected';
                                                                    } ?>>IT Support</option>
                                        <option value="Accountant" <?php if ($data['position'] == 'Accountant') {
                                                                        echo 'selected';
                                                                    } ?>>Accountant</option>
                                    </select>
                                </div>
