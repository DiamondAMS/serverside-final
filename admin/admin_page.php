            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="/employee_list/create_employee_data.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"></i> Create Data</a>
                    </div>
                                    ...
                                    while ($display = mysqli_fetch_array($data)) {
                                        echo '
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="delete_employee_data.php?uid=' . $display['uid'] . '"
                                                        class="btn btn-danger btn-sm"
                                                        onclick="return confirm(\'Decline request?\')">Delete
                                                    </a>
                                                    <a href="employee_list/update_employee_data.php?uid=' . $display['uid'] . '"
